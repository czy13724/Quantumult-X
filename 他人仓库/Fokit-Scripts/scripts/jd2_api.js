...
$.ql_url = $.ql_config.ip_jd2;
if (!$.ql_url.match(/^(http|https)/)) $.ql_url = `http://${$.ql_url}`;

$.application = {
  client_id: $.ql_config.client_id_jd2,
  client_secret: $.ql_config.client_secret_jd2,
};

$.ql_account = {
  username: $.ql_config.username_jd2,
  password: $.ql_config.password_jd2,
};
